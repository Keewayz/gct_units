class CfgPatches {
	class gct_units {
		...
		requiredAddons[] = {
			...
			"A3_Air_F_EPB", "A3_Air_F_EPB_Heli_Light_03",
			"A3_Air_F_EPC", "A3_Air_F_EPC_Plane_CAS_01",
			...
			"A3_Air_F_Heli",
			"A3_Air_F_Heli_Heli_Attack_01", "A3_Air_F_Heli_Heli_Attack_02",
			"A3_Air_F_Heli_Heli_Light_01", "A3_Air_F_Heli_Heli_Light_02",
			"A3_Air_F_Heli_Heli_Light_03", "A3_Air_F_Heli_Heli_Transport_01",
			"A3_Air_F_Heli_Heli_Transport_02",
			"A3_Air_F_Heli_Heli_Transport_03",
			"A3_Air_F_Heli_Heli_Transport_04",
			"A3_Air_F_Heli_Light_01", "A3_Air_F_Heli_Light_02",
			"A3_Animals_F", "A3_Animals_F_Animconfig",
			"A3_Animals_F_Beta", "A3_Animals_F_Beta_Chicken", "A3_Animals_F_Beta_Dog",
			"A3_Animals_F_Beta_Goat", "A3_Animals_F_Beta_Sheep", "A3_Animals_F_Chicken",
			"A3_Animals_F_Dog", "A3_Animals_F_Fishes", "A3_Animals_F_Goat",
			"A3_Animals_F_Kestrel", "A3_Animals_F_Rabbit", "A3_Animals_F_Seagull",
			"A3_Animals_F_Sheep", "A3_Animals_F_Snakes", "A3_Animals_F_Turtle",
			"A3_Anims_F", "A3_Anims_F_Bootcamp", "A3_Anims_F_Config_Sdr",
			"A3_Anims_F_Config_Sdr_WeaponSwitching", "A3_Anims_F_Data",
			"A3_Anims_F_EPA", "A3_Anims_F_EPC", "A3_Anims_F_Exp",
			"A3_Anims_F_Exp_A", "A3_Anims_F_Exp_Revive", "A3_Anims_F_Heli",
...
class CfgUnitInsignia {
	class gct {
		displayName = "GC-Team";
		author = "Wynarator";
		texture = "\gct_units\data\gct_ins.paa";
		textureVehicle = "";
	};
};
//Funkcje - Wirtualny Arsenal/Losowanie Mundurow
#include "CfgFunctions.hpp"
//Frakcje i podgrupy widoczne w edytorze
#include "CfgFactions.hpp"
//Wszystko co arma czyta jako bronie (broń, dodatki do broni, polowa munduru, kamizelki)
#include "CfgWeapons.hpp"
//Wszystko co arma czyta jako pojazdy (pojazdy, jednostki, skrzynie, plecaki, edytorowe przedmioty)
#include "CfgVehicles.hpp"
//Chowa misje sp oraz multiplayer z serwera i klienta
#include "gct_hide_a3_mg.hpp"
//Grafika Startowa
#include "gct_splashscreen.hpp"
//Chowa grupy z A3 oraz dodaje nasze grupy
#include "CfgGroups.hpp"
//Chowa część okularków oraz dodaje ACE do VSMowych tworów
#include "CfgGlasses.hpp"

//Chowa chujowego flasha oraz dodaje ACE do tej bombki
class CfgMagazines {
	class HandGrenade;
	class CA_Magazine;
	...
	class CUP_100Rnd_TE4_LRT4_Red_Tracer_762x51_Belt_M : rhsusf_100Rnd_762x51 {
		scope = 1;
	};
	class CUP_200Rnd_TE4_Red_Tracer_556x45_M249 : rhsusf_100Rnd_556x45_soft_pouch {
		scope = 1;
	};
};