...
////////////KAMIZELE///////////
	...
	//kamizele//
	class TRYK_V_tacSVD_OD : Vest_Camo_Base {
		scope = 1;
	};
	class TRYK_V_Sheriff_BA_TL : Vest_Camo_Base {
		scope = 1;
	};
	class TRYK_V_Sheriff_BA_TBL : Vest_Camo_Base {
		scope = 1;
	};
	class TRYK_V_Sheriff_BA_TCL : Vest_Camo_Base {
		scope = 1;
	};
	class TRYK_V_Sheriff_BA_TL2 : Vest_Camo_Base {
		scope = 1;
	};
	class TRYK_V_Sheriff_BA_TBL2 : Vest_Camo_Base {
		scope = 1;
	};
	class TRYK_V_Sheriff_BA_TCL2 : Vest_Camo_Base {
		scope = 1;
	};
	class TRYK_V_Sheriff_BA_T : Vest_Camo_Base {
		scope = 1;
	};
	class TRYK_V_Sheriff_BA_TB : Vest_Camo_Base {
		scope = 1;
	};
	class TRYK_V_Sheriff_BA_T2 : Vest_Camo_Base {
		scope = 1;
	};
	class TRYK_V_Sheriff_BA_TB2 : Vest_Camo_Base {
		scope = 1;
	};
	class TRYK_V_Sheriff_BA_T3 : Vest_Camo_Base {
		scope = 1;
	};
	class TRYK_V_Sheriff_BA_TB3 : Vest_Camo_Base {
		scope = 1;
	};
	class TRYK_V_Sheriff_BA_T4 : Vest_Camo_Base {
		scope = 1;
	};
	class TRYK_V_Sheriff_BA_TB4 : Vest_Camo_Base {
		scope = 1;
	};
	class TRYK_V_Sheriff_BA_T5 : Vest_Camo_Base {
		scope = 1;
	};
	class TRYK_V_Sheriff_BA_TB5 : Vest_Camo_Base {
		scope = 1;
	};
	class TRYK_V_Sheriff_BA_TBL3_BK : Vest_Camo_Base {
		scope = 1;
	};
	class TRYK_V_Sheriff_BA_TBL3_OD : Vest_Camo_Base {
		scope = 1;
	};
	class TRYK_V_Sheriff_BA_TBL3_TN : Vest_Camo_Base {
		scope = 1;
	};
	class TRYK_V_tacSVD_BK : Vest_Camo_Base {
		scope = 1;
	};
	//GPNVG-18
	...
	class A3_GPNVG18_REC_F: A3_GPNVG18_F {
		displayName = "GPNVG-18 TAN (Recon)";
	};
	class A3_GPNVG18b_F: A3_GPNVG18_F {
		displayName = "GPNVG-18 TAN (Battery)";
	};
	class A3_GPNVG18b_REC_F: A3_GPNVG18_F {
		displayName = "GPNVG-18 TAN (Recon/Battery)";
	};
	//CHOWAMY TI
	class A3_GPNVG18_TI: A3_GPNVG18_F {scope = 1; scopecurator=1;};
	class A3_GPNVG18_BLK_TI: A3_GPNVG18_F {scope = 1; scopecurator=1;};
	class A3_GPNVG18b_BLK_TI: A3_GPNVG18_F {scope = 1; scopecurator=1;};
	class A3_GPNVG18_REC_BLK_TI: A3_GPNVG18_F {scope = 1; scopecurator=1;};
	class A3_GPNVG18b_REC_BLK_TI: A3_GPNVG18_F {scope = 1; scopecurator=1;};
	class A3_GPNVG18b_TI: A3_GPNVG18_F {scope = 1; scopecurator=1;};
	class A3_GPNVG18_REC_TI: A3_GPNVG18_F {scope = 1; scopecurator=1;};
	class A3_GPNVG18b_REC_TI: A3_GPNVG18_F {scope = 1; scopecurator=1;};
	class A3_NVGHeadGearBlk_F: ItemCore {scope = 1; scopecurator=1;};